...
if (args.has("--dry-run")) {
  ...
  console.log("Usage: node scripts/migrate-json-to-d1.mjs --dry-run|--export-sql|--import-local");
  process.exitCode = 1;
}
...
async function importLocal() {
  ...
  try {
    ...
    if (error.code === "ENOENT") {
      throw new Error("Missing db/seed/from-json.sql. Run npm run d1:export-sql first.");
    }
    throw error;
  }
