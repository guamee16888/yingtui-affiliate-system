...
const server = createServer(async (request, response) => {
  ...
  try {
    ...
    response.end(successHtml(updates.X_ACCESS_TOKEN_EXPIRES_AT));
    console.log("X access token saved to .env.");
...
function successHtml(expiresAt) {
  return `<!doctype html>
<html lang="zh-CN">
  ...
  <body style="font-family: system-ui; max-width: 720px; margin: 48px auto; line-height: 1.6;">
    <h1>X 授权完成</h1>
    <p>Access token 已保存到本地 <code>.env</code>。</p>
